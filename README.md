...
It supports data quality control, interactive annotation, burst/tonic/pause/high-frequency candidate generation, eventness auditing, Mean-ISI, Pasquale logISIH/newBD, pCLAMP-style Poisson Surprise, and Robust Gaussian Surprise support analyses, and reproducible export reports. Support analyses remain auxiliary evidence and never overwrite STPD AUTO labels.
