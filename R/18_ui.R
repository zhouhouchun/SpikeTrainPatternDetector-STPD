  ...
  div(
    ...
    sidebarPanel(
      ...
      tags$details(
          ...
          tags$small("Mean-ISI\u3001Pasquale logISIH/newBD\u3001Poisson Surprise \u548C RGS \u4EC5\u63D0\u4F9B\u8F85\u52A9\u8BC1\u636E\uFF1BAUTO \u6807\u7B7E\u4ECD\u7531\u4E3B\u68C0\u6D4B\u5668\u548C\u590D\u6838\u6D41\u7A0B\u63A7\u5236\u3002"),
          tags$hr(),
                     ...
                     fluidRow(
                       column(3,
                              ...
                              tags$div(class = "small-note",
                                       ...
                                       "\u8FD0\u884C\u4EFB\u4E00\u8F85\u52A9\u65B9\u6CD5\u540E\uFF0C\u5019\u9009 burst \u4F1A\u6807\u8BB0\u5728\u76F8\u90BB spike \u4E4B\u95F4\u7684 ISI \u533A\u95F4\u4E0A\uFF0C\u800C\u4E0D\u662F\u5B64\u7ACB spike tick \u4E0A\u3002\u56DB\u79CD\u65B9\u6CD5\u4F7F\u7528\u72EC\u7ACB\u989C\u8272\u548C\u5782\u76F4\u504F\u79FB\uFF1B\u53EF\u9009\u4E8B\u4EF6\u5305\u7EDC\u4EE5\u534A\u900F\u660E\u65B9\u5F0F\u663E\u793A\u5B8C\u6574\u5019\u9009\u8303\u56F4\u3002"),
                              ...
                              conditionalPanel("input.support_method_view == 'ps'",
                                ...
                                tags$div(class = "small-note",
                                         "\u7ECF\u5178 Poisson-surprise Burst \u5019\u9009\u3002\u8BE5\u6A21\u5757\u4EC5\u63D0\u4F9B\u8F85\u52A9\u8BC1\u636E\uFF0C\u4E0D\u6539\u5199 STPD AUTO \u6807\u7B7E\u3002"),
                                ...
                                numericInput("ps_min_spikes", "\u6700\u5C0F spike \u6570", value = 3, min = 3, step = 1),
                              ...
                              conditionalPanel("input.support_method_view == 'rgs'",
                                ...
                                tags$div(class = "small-note",
                                         "RGS \u5728\u58F0\u660E\u7684 reference group \u5185\u62DF\u5408 normalized log-ISI \u5206\u5E03\uFF0C\u540C\u65F6\u751F\u6210 Burst \u548C Pause \u8F85\u52A9\u8BC1\u636E\u3002\u4E0D\u8981\u5728\u672A\u9884\u5148\u58F0\u660E\u65F6\u6DF7\u5408\u4E0D\u540C\u6838\u56E2/\u961F\u5217\u3002"),
                                checkboxInput("rgs_support_visible_only", "\u4EC5\u5728\u5F53\u524D\u53EF\u89C1 trains \u4E0A\u8FD0\u884C", TRUE),
                                textInput("rgs_reference_group", "Reference group \u540D\u79F0", value = "current_dataset"),
                                numericInput("rgs_alpha", "Bonferroni \u540E alpha", value = 0.05, min = 0.0001, max = 0.5, step = 0.01),
                                ...
                                numericInput("rgs_min_burst_spikes", "Burst \u6700\u5C0F spike \u6570", value = 3, min = 3, step = 1),
                       ...
                       column(9,
                              ...
                              tags$div(class = "small-note",
                                       tags$b("\u9605\u8BFB\u6307\u5357\uFF1A"),
                                       "\u652F\u6301\u65B9\u6CD5\u68C0\u6D4B\u5230\u7684 burst \u5019\u9009\u4EE5\u65B9\u6CD5\u989C\u8272\u6761\u663E\u793A\u5728\u76F8\u90BB spike \u7684 ISI \u533A\u95F4\u4E0A\uFF1AMean-ISI = \u7D2B\u8272\uFF0CLogISI/newBD = \u7C89\u8272\uFF0CPoisson Surprise = \u6A59\u8272\uFF0CRGS Burst = \u7EFF\u8272\u3002\u9ED1\u8272\u7AD6\u7EBF\u4ECD\u8868\u793A spike timestamp\uFF1B\u4E2D\u95F4\u6761\u5E26\u4E3A\u5F53\u524D AUTO burst-family\u3002"),
                              ...
                              tabsetPanel(
                                ...
                                tabPanel("Poisson Surprise",
                                  h4("PS \u652F\u6301\u6458\u8981"),
                                  DTOutput("ps_support_summary_table"),
                                  tags$hr(),
                                  h4("PS Burst \u7279\u5F81"),
