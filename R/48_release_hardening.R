...
if (getRversion() >= "2.15.1") {
  utils::globalVariables(c(
    ...
    "Pre_LV", "pre_ratio_q", "pre_score", "precision",
    ...
    "time_align_sec", "timestamp_left_sec", "timestamp_right_sec",
	    "group", "window_end_sec", "window_start_sec",
    ...
    "input", "session", "rv", "aligned_data", "apply_manual_selection",
    "consume_ui_confirmation", "current_ui_dataset_identity", "current_ui_params",
    "data_load_progress", "detector_summary_current", "push_ui_undo",
    "reset_dataset_bound_ui_state", "ui_condition_detail",
    "ui_control_remembered", "ui_language", "ui_text",
    "run_manual_ui_action", "select_default_timestamp_tab",
    "show_ui_confirmation", "ui_run_identity_for",
