...
public enum STPDLocalization {
    ...
    public static let exactDictionary: [String: String] = [
        ...
        "对数 Y": "log Y",
        "显示伪迹与疑似不应期阈值。": "Show artifact and refractory-suspect thresholds.",
        "显示伪迹与绝对不应期阈值。": "Show artifact and absolute-refractory thresholds.",
        ...
        "打开 CSV": "Open CSV",
        "加载示例": "Load Sample",
        "伪迹 / 最小有效 ISI": "Artifact / min valid ISI",
        "伪迹阈值单位": "Artifact threshold unit",
        ...
        "当前硬阈值以下无伪迹 ISI。": "No artifact ISI below the current hard threshold.",
        "ISI 索引": "ISI index",
        "阈值": "Threshold",
